...
int main()
{
	...
	Shader shaderprogram("../VS2017/3dVerSha.glsl", "../VS2017/3dFraSha.glsl");
	shaderprogram.use();
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//camera direction is the the opposite of where it is targeting
		...
		*/
		...
		for (int i = 0; i < 10; i++)
		{
			...
			model = rotate(model, (float)glfwGetTime() * glm::radians(angle), glm::vec3(0.0f, 0.0f, 1.0f));
